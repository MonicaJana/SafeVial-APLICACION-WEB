...
const perfil = async (req, res) => {
    ...
    try {
        delete req.usersBDD.token;
        delete req.usersBDD.confirmarEmail;
        delete req.usersBDD.createdAt;
        delete req.usersBDD.updatedAt;
        delete req.usersBDD.__v;

        res.status(200).json(req.usersBDD)
        console.log(req.usersBDD)
    } catch (error) {
