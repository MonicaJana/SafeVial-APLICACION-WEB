...
const sendMailToUser = (userMail, token) => {
    ...
    let mailOptions = {
        ...
        html: `<p>Hola, haz clic <a href="${process.env.URL_FRONTEND}confirmar/${encodeURIComponent(token)}">aquí</a> para confirmar tu cuenta.</p>`  //cuerpo del mensaje
    };
...
const sendMailToRecoveryPassword = async(userMail,token)=>{
    ...
    <hr>
    <footer>Safevialuio te da la Bienvenida!</footer>
    `
    });
